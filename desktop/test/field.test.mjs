...
test('generates current tablet routes', () => { assert.deepEqual(tabletUrls('10.0.0.10'), {admin:'http://10.0.0.10:8080/admin',judge:'http://10.0.0.10:8080/judge',priority:'http://10.0.0.10:8080/priority',priorityDisplay:'http://10.0.0.10:8080/priority-display',display:'http://10.0.0.10:8080/display',overlay:'http://10.0.0.10:8080/overlay'}); });
