...
if (dashboard) dashboard.insertAdjacentHTML('beforeend', '<section class="card"><h2>Competition safety</h2><p id="competition">Checking authoritative DB…</p></section><section class="card"><h2>Disk</h2><p id="disk">Checking…</p></section><section class="card wide"><h2>LAN QR</h2><div id="qr"></div><p class="hint">QR contains only the verified LAN Admin URL.</p></section>');
