...
-- Additive migration 9: Fix recursion in bulk_upsert_planning_safe_v4_legacy
create or replace function public.bulk_upsert_planning_safe_v4_legacy(
  p_event_id bigint,
  p_category text,
...
revoke all on function public.bulk_upsert_planning_safe_v4_legacy(bigint,text,boolean,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb) from public;
grant execute on function public.bulk_upsert_planning_safe_v4_legacy(bigint,text,boolean,jsonb,jsonb,jsonb,jsonb,jsonb,jsonb) to anon,authenticated,service_role;
