...
async function runGate2() {
  ...
  execSync(`docker exec surfjudging_p38_manonman_test2_postgres psql -U postgres -d postgres -c "UPDATE public.heats SET status = 'open', is_active = true WHERE id IN ('${H1_ID}', '${H2_ID}');"`);
